...
$q_view['my']=array(
			'label' => qa_html(qa_opt('extra_field_el')),
			// 'content' => qa_html(qa_block_words_replace($question['exra'], qa_get_block_words_preg())),
		);
	return $q_view;
	//echo $questionDb;
	// $query="INSERT INTO
	...
	switch (qa_user_post_permit_error('permit_post_a', $question, QA_LIMIT_ANSWERS)) {
		...
		case false:
			...
			$form=array(
                ...
                'tags' => 'method="post" action="http://localhost/vega/index.php"',
				...
				'buttons' => array(
                    'table' =>array(
                        ...
                        //'tags' => 'onclick="http://localhost/q2a/index.html"',
...
//	return $x;
    ...
    $x='<form method = "post" action ="index.html"
